...
**Research Interests**
======
Dr. Zhao's research interests mainly include low-level computer vision (e.g., image and video processing) and generative models (e.g., GAN and diffusion model). Recently, he focuses on applications of Multimodal Large Language Model (MLLM).
